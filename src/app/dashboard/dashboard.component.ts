...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  public ngOnInit() {
    ...
    const dataSimpleBarChart = {
      ...
      series: [
        [40, 30, 40, 35, 23, 55, 55, 11, 35, 40, 56, 75],
        [40, 35, 35, 55, 35, 55, 50, 23, 11, 35, 75, 40],
        [30, 35, 30, 40, 50, 11, 35, 11, 23, 75, 76, 50],
      ],
    };
    ...
    const dataMultipleBarsChart = {
      ...
      series: [
        [15, 30, 44, 50, 19, 99, 17, 55],
        [88, 33, 55, 22, 88, 12, 9, 34],
      ],
    };
