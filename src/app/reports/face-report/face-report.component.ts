...
@Component({
  selector: "app-face-report",
  templateUrl: "./face-report.component.html",
  styleUrls: ["./face-report.component.css"],
})
    ...
    if (startDate != 0 && endDate != 0) {
      ...
      axios
        ...
        .then((res: any) => {
          ...
          if (e.Item != "") {
            if (e.Item == "1") {
              this.dataFace = this.dataFace.filter((w) => w.meta.glasses == 1);
            }
            if (e.Item == "2") {
              this.dataFace = this.dataFace.filter((w) => w.meta.sunglass == 1);
            }
            if (e.Item == "3") {
              this.dataFace = this.dataFace.filter((w) => w.meta.mask == 1);
            }
            if (e.Item == "4") {
              this.dataFace = this.dataFace.filter((w) => w.meta.hat == 1);
            }
          }

          this.faceReportData = this.dataFace;
          this.loadingVisible = false;
        })
        .catch((err) => {
          console.log(err.message);
